...
void setup() {
  ...
  Display.print(F("Relay Station v3.0"));
...
void loop() {
  ...
  if (DataPacket.receiveData()) {
    ...
    // delay(50 * (6 - AirDataRate));
    // delay(100);
    // ESerial.flush();
    //DumpData();

    DataID = Data.ID_RPM >> 12;
    DataSource = Data.LAPSPEED_SOURCE & 0b1111; // car is data source 15
    int MotorRPM = Data.ID_RPM & 0b0000111111111111;
...
void DumpData() {
  ...
  Serial.print("ID_RPM ");          Serial.println(Data.ID_RPM, BIN );
  Serial.print("WARNINGS_TEMPF "); Serial.println( Data.WARNINGS_TEMPF, BIN );
  Serial.print("VOLTS_LAPS ");      Serial.println( Data.VOLTS_LAPS , BIN);
  Serial.print("SPEED_EREM ");       Serial.println( Data.SPEED_EREM , BIN);
  Serial.print("DISTANCE_TREM ");   Serial.println( Data.DISTANCE_TREM, BIN );
  Serial.print("AMPS_D0ID ");       Serial.println( Data.AMPS_D0ID, BIN );
  Serial.print("RACETIME ");        Serial.println( Data.RACETIME, BIN );
  Serial.print("ENERGY_D0LAPS ");   Serial.println( Data.ENERGY_D0LAPS, BIN );
  Serial.print("D1LAPS_D1ID_D2ID "); Serial.println( Data.D1LAPS_D1ID_D2ID , BIN);
  Serial.print("D0TIME ");          Serial.println( Data.D0TIME , BIN);
  Serial.print("D0SHORTLAP ");      Serial.println( Data.D0SHORTLAP, BIN );
  Serial.print("D0ENERGY_D0EFF ");  Serial.println( Data.D0ENERGY_D0EFF, BIN );
  Serial.print("D1TIME ");          Serial.println( Data.D1TIME , BIN);
  Serial.print("D1SHORTLAP ");       Serial.println( Data.D1SHORTLAP, BIN );
  Serial.print("D1ENERGY_D1EFF ");  Serial.println( Data.D1ENERGY_D1EFF, BIN );
  Serial.print("D2TIME ");          Serial.println( Data.D2TIME, BIN );
  Serial.print("D2SHORTLAP ");      Serial.println( Data.D2SHORTLAP, BIN );
  Serial.print("D2ENERGY_D2EFF ");  Serial.println( Data.D2ENERGY_D2EFF, BIN );
  Serial.print("D2LAPS_LAP2AMPS "); Serial.println( Data.D2LAPS_LAP2AMPS, BIN );
  Serial.print("D0FASTLAP ");       Serial.println( Data.D0FASTLAP, BIN );
  Serial.print("D1FASTLAP ");       Serial.println( Data.D1FASTLAP, BIN );
  Serial.print("D2FASTLAP ");       Serial.println( Data.D2FASTLAP, BIN );
  Serial.print("CURD_LAPRPM ");     Serial.println( Data.CURD_LAPRPM, BIN );
  Serial.print("LAPTIME ");         Serial.println( Data.LAPTIME , BIN);
  Serial.print("LAPENERGY_WARNINGS2 "); Serial.println( Data.LAPENERGY_WARNINGS2, BIN );
  Serial.print("LAPSPEED_SOURCE "); Serial.println( Data.LAPSPEED_SOURCE, BIN );
  Serial.print("LAPAMPS_DISPLAYID ");  Serial.println( Data.LAPAMPS_DISPLAYID, BIN );
  Serial.print("LAPDIST ");       Serial.println( Data.LAPDIST , BIN);
  Serial.print("DISTHOME ");        Serial.println( Data.DISTHOME , BIN);
  Serial.println("__________________________________");
