...
#define VERSION "Signal repeater 1.75"
...
void setup() {
  ...
  DeviceIDBtn.init(200, 20, 60, 35, C_WHITE, C_DKGREY, C_WHITE, C_BLACK, "x", 0, 0, &FONT_ITEM);
...
void loop() {
  ...
  if (DataPacket_0.receiveData()) {
    ...
    if (SourceID != DeviceID) {
      ...
      Data_0.LAP2AMPS_D2ID_SID = Data_0.LAP2AMPS_D2ID_SID & 0b1111111111111100;

      // now save actual data
      Data_0.RPM_DNO_DID = Data_0.RPM_DNO_DID | (DeviceID & 0b0000000000000011);
      Data_0.LAP2AMPS_D2ID_SID = Data_0.LAP2AMPS_D2ID_SID | (SourceID & 0b0000000000000011);
  ...
  if (DataPacket_1.receiveData()) {
    ...
    if (SourceID != DeviceID) {
      ...
      Data_1.LAP2AMPS_D2ID_SID = Data_1.LAP2AMPS_D2ID_SID & 0b1111111111111100;

      // now save actual data
      Data_1.RPM_DNO_DID = Data_1.RPM_DNO_DID | (DeviceID & 0b0000000000000011);
      Data_1.LAP2AMPS_D2ID_SID = Data_1.LAP2AMPS_D2ID_SID | (SourceID & 0b0000000000000011);
  ...
  if (DataPacket_2.receiveData()) {
    ...
    if (SourceID != DeviceID) {
      ...
      Data_2.LAP2AMPS_D2ID_SID = Data_2.LAP2AMPS_D2ID_SID & 0b1111111111111100;

      // now save actual data
      Data_2.RPM_DNO_DID = Data_2.RPM_DNO_DID | (DeviceID & 0b0000000000000011);
      Data_2.LAP2AMPS_D2ID_SID = Data_2.LAP2AMPS_D2ID_SID | (SourceID & 0b0000000000000011);
...
void SendPings() {
  ...
  */
  ...
  while (1) {
    ...
    Data_0.RPM_DNO_DID = Data_0.RPM_DNO_DID | (DeviceID & 0b0000000000000011);
    Data_0.LAP2AMPS_D2ID_SID = Data_0.LAP2AMPS_D2ID_SID & 0b1111111111111100;
    // in making volts 0, the wifi server will consider this ping mode
    Data_0.VOLTS_LAPS = 0;
    ...
    Display.fillRect(130, 60, 100, 50, C_BLACK);
...
void ProcessLoopTouch() {
  ...
  if ((BtnX > 50) && (BtnX < 250) && (BtnY < 100) && (BtnY > 10)) {
    PingCount = 0;
    SendPings();
    Display.fillScreen(C_BLACK);
    Serial_0.flush();
